...
% 18273-pro, 18275-ser, 18360-tyr]
bux_ban_aa_of_interest = bux;
% bux_ban_aa_of_interest(18351) = 0; 
...
rxns_gly_engaged = find(row_targeted_metabolite ~= 0)';
targeted_rxn = (rxns_gly_engaged == 1810); 
rxns_gly_engaged_that_remain_unchanged_flux = rxns_gly_engaged(~targeted_rxn);
blx_case = blx_add_biomass_lb;
blx_case(rxns_gly_engaged_that_remain_unchanged_flux) = v_ref(rxns_gly_engaged_that_remain_unchanged_flux); 
bux_case = bux_ban_aa_of_interest;
bux_case(rxns_gly_engaged_that_remain_unchanged_flux) = v_ref(rxns_gly_engaged_that_remain_unchanged_flux); 
