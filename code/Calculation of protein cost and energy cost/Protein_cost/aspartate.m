...
rxns_asp_engaged = find(row_targeted_metabolite ~= 0)';
targeted_rxn = (rxns_asp_engaged == 18223); % (*******)
rxns_asp_engaged_that_remain_unchanged_flux = rxns_asp_engaged(~targeted_rxn);
blx_case = blx_add_biomass_lb;
blx_case(rxns_asp_engaged_that_remain_unchanged_flux) = v_ref(rxns_asp_engaged_that_remain_unchanged_flux); 
bux_case = bux_ban_aa_of_interest;
bux_case(rxns_asp_engaged_that_remain_unchanged_flux) = v_ref(rxns_asp_engaged_that_remain_unchanged_flux); 
