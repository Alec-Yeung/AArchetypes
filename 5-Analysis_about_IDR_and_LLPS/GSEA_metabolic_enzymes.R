...
###
df_cost <- read.xlsx('Human_metabolic_enzyme_cost.xlsx')
...
names(genelist) <- as.character(df_cost_decreasing$Gene)
head(genelist)
...
res <- fgsea(pathways = pathway_all,
             stats = genelist,
             minSize = 10, maxSize = 2000, nperm = 10000)
...
ggsave('Distribution of NES - metabolic enzyme.jpg',P,
...
ggsave('GSEA NES by pathway-metabolic enzyme.jpg',P, width = 10, height = 7, limitsize = FALSE, dpi = 1000)
